    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
            ...
            backgroundColor: Color(0xFF796FE1),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Container(
                          child: Container(
                            decoration: BoxDecoration(color: Color(0xFF796FE1).withOpacity(0.3)),
                        ...
                        Hero(
                          tag: Key("upload"),
                          child: Card(
                            color: Color(0xFF796FE1).withOpacity(0.7),
                            child: InkWell(
                              onTap: () {
                                _imgFromGallery();
                              },
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              color: Color(0xFF796FE1).withOpacity(0.5),
                              child: Padding(
